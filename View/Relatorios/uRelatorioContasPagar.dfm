inherited frmRelatorioContasPagar: TfrmRelatorioContasPagar
  ...
  object RLReport1: TRLReport
    ...
    object RLBand1: TRLBand
      ...
      object RLLabel1: TRLLabel
        ...
        Width = 267
        Height = 23
        Caption = 'RELAT'#211'RIO DE CONTAS '#192' PAGAR'
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clBlack
        Font.Height = -19
        Font.Name = 'Calibri'
    ...
    object RLGroup1: TRLGroup
      ...
      object RLBand4: TRLBand
        ...
        object RLDraw1: TRLDraw
          ...
          Borders.DrawRight = False
          Borders.DrawBottom = True
          Borders.Color = 10658466
          Borders.Style = bsBDiagonal
          Brush.Color = 16050915
          Pen.Color = 16050915
        end
        object RLLabel3: TRLLabel
          ...
          Height = 14
          Caption = 
            'N'#186' PARCELA    VENCIMENTO                                        ' +
            '                        VLR. PARCELA           VALOR PAGO      R' +
            'ESTANTE         STATUS'
          Font.Charset = DEFAULT_CHARSET
          Font.Color = 11298594
          Font.Height = -12
    ...
    object RLBand3: TRLBand
      ...
      object RLLabel5: TRLLabel
        ...
        Height = 14
        Caption = 
          'N'#186' DOC.       DESCRI'#199#195'O DA CONTA                                ' +
          '                                                           TOTAL' +
          ' CONTA      VALOR PAGO         RESTANTE      STATUS'
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clBlack
        Font.Height = -12
        Font.Name = 'Calibri'
  ...
  object qryContas: TFDQuery
    ...
    object qryContasNR_DOCUMENTO: TStringField
    ...
    object qryContasID_PARCELA: TIntegerField
      FieldName = 'ID_PARCELA'
    end
    object qryContasNUMERO_PARCELA: TSmallintField
      FieldName = 'NUMERO_PARCELA'
    end
    object qryContasVALOR_PARCELA: TBCDField
      FieldName = 'VALOR_PARCELA'
      DisplayFormat = ' ,0.00'
      currency = True
      Size = 2
    end
    object qryContasVLRPG_PARCELA: TBCDField
      FieldName = 'VLRPG_PARCELA'
      DisplayFormat = ' ,0.00'
      currency = True
      Size = 2
    end
    object qryContasSTATUSPARCELA: TStringField
      FieldName = 'STATUSPARCELA'
      Size = 12
    end
    object qryContasDT_VENCIMENTO: TDateField
